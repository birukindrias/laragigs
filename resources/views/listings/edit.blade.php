            ...
            <div class="bg-gray-50 border border-gray-200 p-10 rounded max-w-lg mx-auto mt-24">
                ...
                <form action="/listings/update/{{ $listing->id }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-6">
                        ...
                        <input value="{{ $listing->title }}" type="text"
                    ...
                    <div class="mb-6">
                        ...
                        <input value="{{ $listing->email }}" type="text"
                    ...
                    <div class="mb-6">
                        ...
                        <input value="{{ $listing->website }}" type="text"
                    ...
                    <div class="mb-6">
                        ...
                        <input value="{{ $listing->tags }}" type="text"
                    ...
                    <img src="{{ asset('storage/' . $listing->logo) }}" class="w-full" alt="">
